...
final case class Use[D <: TopD](variableName: OldCode[OldNameG[D]]) extends OldCode[ExvrG[D]]

// todo merge Use and Assign into something like Loc
final case class Assign[D <: TopD](variableName: OldCode[OldNameG[D]]) extends OldCode[XcvrG[D]]

object Declaration:
  final case class ImmutableVariable[D <: TopD](
    name: OldCode[OldNameG[D]],
  ...
  final case class FreshChannel[D <: TopD](
    name: OldCode[OldNameG[ChanD[D, D]]],
