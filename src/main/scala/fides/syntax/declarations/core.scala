...
import fides.syntax.types.{ChanT, DeclS, Expr, Exvr, NameS, TopT, TypeS, Xctr, Xcvr}
...
final case class Assign[T <: TopT](variableName: Code[NameS[T]]) extends Code[Xcvr[T]]
