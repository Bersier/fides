...
sealed trait TrimmedR[S <: TopS, C <: Code3[S, TopM], RC <: Code3[S, SomeM[TopP, BotM]]]
// todo not sure if we should keep the type parameter S
object TrimmedR:
  given [
    T1 <: TopT, T2 <: TopT, P <: TopP,
    S1 <: Polar2[T1, P], S2 <: Polar2[T2, P], H <: TopP, M <: TopM,
    C1 <: Code3[S1, SomeM[H, M]], C2 <: Code3[S2, SomeM[H, M]],
    RC1 <: Code3[S1, SomeM[H, BotM]], RC2 <: Code3[S2, SomeM[H, BotM]],
