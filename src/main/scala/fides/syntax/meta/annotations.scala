...
import fides.syntax.types.{Cnst, CodeType, Expr, NaturalNumberT, QuotedT, ValTop}
...
/**
  ...
  */
final case class Annotated[S <: CodeType, T <: ValTop](code: Code[S], annotation: Code[Cnst[T]]) extends Code[S]
