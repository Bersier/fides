...
/**
  ...
  */
final case class NatLit[B <: Bits] @publicInBinary private(bits: B) extends Code[ConsM[Ntrl2S[NatD[B]], BotQ]]:
...
final case class Add[
  ...
  M <: ConsM[S, Q],
](terms: Code[M]) extends Code[AddM[S, Q, M]]
...
final case class Multiply[
  S <: Expr2S[CollectedUD[NatUD]], Q <: TopQ,
  M <: ConsM[S, Q],
](factors: Code[M]) extends Code[MultiplyM[S, Q, M]]
...
](lhs: Code[M1], rhs: Code[M2]) extends Code[CompareM[S1, S2, Q, M1, M2]]
