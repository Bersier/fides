...
/**
  ...
  */
final case class Identifier[K <: ID] private(private val k: K) extends OldCode[Ntrl[IdentifierT[K]]]
object Identifier:
...
/**
  ...
  */
final case class IdentifierKey[K <: ID] private(private val k: K) extends OldCode[Ntrl[IdentifierKeyT[K]]]
...
/**
  ...
  */
final case class NewIdentifier() extends OldCode[Exvr[IdentifierUT]]

/**
  * Outputs a new identifier key.
  */
final case class NewIdentifierKey() extends OldCode[Exvr[IdentifierKeyUT]]
...
final case class ExtractIdentifier[K <: ID](
  key: OldCode[Expr[IdentifierKeyT[K]]],
) extends OldCode[Exvr[IdentifierT[K]]]
