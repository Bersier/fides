...
/**
  ...
  * So every [[NtrlS]] should be singleton-typed. That is why [[Identifier]] takes an [[ID]].
  ...
  */
final case class Identifier[K <: ID] private(private val k: K) extends OldCode[NtrlS[IdentifierD[K]]]
object Identifier:
...
/**
  ...
  */
final case class IdentifierKey[K <: ID] private(private val k: K) extends OldCode[NtrlS[IdentifierKeyD[K]]]
...
/**
  ...
  */
final case class NewIdentifier() extends OldCode[ExvrS[IdentifierUD]]

/**
  * Outputs a new identifier key.
  */
final case class NewIdentifierKey() extends OldCode[ExvrS[IdentifierKeyUD]]
...
final case class ExtractIdentifier[K <: ID](
  key: OldCode[ExprS[IdentifierKeyD[K]]],
) extends OldCode[ExvrS[IdentifierD[K]]]
