...
(testValue: Code[Val[A]], exctractor: Code[Xctr[T]]) extends Code[XctrCase[T, A]], CodeType

final case class ExprCase[T <: ValType, A <: Atom]
(testValue: Code[Val[A]], value: Code[Expr[T]]) extends Code[ExprCase[T, A]], CodeType
